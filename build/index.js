...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Text_Parsing_Parser = PS["Text.Parsing.Parser"];        
  var glitter = function (dictGeneric) {
  ...
  var glitter$prime = function (dictGeneric) {
      return Data_Function.flip(glitter(dictGeneric))(Control_Category.id(Control_Category.categoryFn));
  };
  exports["glitter"] = glitter;
  exports["glitter'"] = glitter$prime;
})(PS["TestHelpers"] = PS["TestHelpers"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Bind = PS["Control.Bind"];
  ...
  var TestHelpers = PS["TestHelpers"];
  var Type_Row = PS["Type.Row"];        
  var thingToSparkle = function (m) {
      return function (n) {
          return function (s) {
              var parse = Data_Functor.map(Data_Functor.functorFn)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Array.singleton))(TestHelpers["glitter'"](Logics_Intuitionistic_Propositional.genericExpr)(Logics_Intuitionistic_Propositional.exprParser));
              var evaluate = Data_Kripke_Kripke.runEvaluation(Logics_Intuitionistic_Propositional.evaluation);
              return Control_Bind.bind(Data_Either.bindEither)(parse(s))(function (v) {
                  return evaluate(m)(n)(v);
              });
          };
      };
  };
  ...
  var main = Sparkle.sparkle(Sparkle.interactiveFunction(Sparkle.flammableRecord()(Sparkle.flammableListCons(Sparkle.flammableArray(Sparkle.flammableTuple(Sparkle.flammableString)(Sparkle.flammableString)))(Sparkle.flammableListCons(Sparkle.flammableRecord()(Sparkle.flammableListCons(Sparkle.flammableArray(Sparkle.flammableTuple(Sparkle.flammableString)(Sparkle.flammableString)))(Sparkle.flammableListCons(Sparkle.flammableArray(Sparkle.flammableString))(Sparkle.flammableListNil)(Type_Row.rowLacks()()()(Type_Row.rowLacking))()()(new Data_Symbol.IsSymbol(function () {
      ...
      return "domain";
  }))))(Sparkle.interactiveFunction(Sparkle.flammableString)(Sparkle.interactiveFunction(Sparkle.flammableString)(Sparkle.interactiveEither(Data_Generic.genericArray(Data_Generic.genericString))(Data_Generic.genericBool)))))("model validation")(thingToSparkle);
  exports["main"] = main;
  exports["readModel"] = readModel;
  exports["thingToSparkle"] = thingToSparkle;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
